    ...
    <div class="container">
        <div class="row">
            ...
            <div class="main col-md-12">
                ...
                <!-- page-title start -->
                <!-- ================ -->
                <h1 class="page-title margin-top-clear">Megafill MH</h1>
                <!-- page-title end -->
                ...
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <div class="tab-pane active" id="product-images">
                                <div class="owl-carousel content-slider-with-controls-bottom">
                                    <div class="overlay-container">
                                        ...
                                        <a href="/images/products/p6.png" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                                    </div>
                                    <div class="overlay-container">
                        ...
                        <!-- Tab panes end-->
                        <hr>
                        <span class="price"><del>₮45,000</del> ₮39,000</span>
                            ...
                            <div class="side product-item vertical-divider-left">
                                <div class="tabs-style-2">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li><a href="#h2tab2" role="tab" data-toggle="tab"><i class="fa fa-files-o pr-5"></i>Тодорхойлолт</a></li>
                                        <li><a href="#h2tab3" role="tab" data-toggle="tab"><i class="fa fa-star pr-5"></i>(3) Харилцагчдын үнэлгээ</a></li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content padding-top-clear padding-bottom-clear">
                                        <div class="tab-pane fade in active" id="h2tab1">
                                            <h4 class="title">Megafill MH is an universal light curing Microhybrid Composite</h4>
                                            <p>Megafill MH is an universal light curing Microhybrid Composite for restorations in the anterior- and posterior tooth area. The continuous plastic consistency and large color assortment allows excellent usability of the material and is well suited for the classic filling therapy and layer technique in filling structures. Megafill MH can be polished to a high gloss and offers a highly esthetic restoration. The fillers contain fine dental glass particles and highly dispersible silicone oxides, which are specifically treated and cover the surface with a hydrophobic layer. The surface of Megafill MH is therefore resistant and protected from residue deposits and discolorations. Megafill MH is X-ray-opaque and has a fluorescent effect like the natural tooth structure.</p>
                                            <p>The homogeneous structure of the investments and the selected fillers guaran- tee the chameleon effect and natural opalescence. The high gloss polish capa- bility insures a long color retention and natural esthetic of the restoration. The pleasant process paired with the outstanding characteristics and the uni- versal applicability of Megafill MH stand for a high quality and long lifetime of the restoration.</p>
                                        </div>
